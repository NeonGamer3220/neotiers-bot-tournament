...
def parse_timestamp(raw: str) -> datetime:
    """Parse a user-supplied timestamp string into a UTC-aware datetime.

    Accepted forms include ISO-8601 (``2026-06-25T18:00:00+02:00``,
    ``2026-06-25T18:00:00Z``, ``2026-06-25T18:00:00.123456``) and the
    convenient ``YYYY-MM-DD HH:MM`` shorthand. Naive datetimes are assumed
    to be UTC.
